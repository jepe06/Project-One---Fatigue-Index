...
{T}{he} evolution in performance of high performance athletes is highly dependent on their skill, motivation, and discipline. With the support of a knowledgeable coach, the evolution can be substantially improved. In recent years, more and more  sports coaches have relied heavily on collected data to better plan and adjust the training plans of their athletes. This allows for a fine balance between intense workouts, that generate more stimulus for muscle development and sport specific skills, taking the balance between effort and fatigue as the crucial ratio to respect. Too high effort, may lead to injury, too low and some gains may be left on the table. 
...
There are many examples of modeling techniques to assess fatigue, across several sports and prediction windows. The use of machine learning models for sports related prediction has been known at least since 2010, where Gabbet and colleagues modeled the risk of injury with a monodimensional approach using logistic regression, based on athletes rate of perceived exertion. In recent years, several authors have focused in alternative techniques such as Random Forest, Support Vector Machine, or Convulotional Neural Network on Multivariate Timeseries (the references for these papers can be found in the paper "A Narrative Review").
