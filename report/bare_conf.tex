...
\begin{tikzpicture}[node distance=1.5cm, font=\footnotesize] % Adjust font size to match document
...
From it we could exclude several of the features, which are verified by how the classes are distributed across the scales for each feature. Figure \ref{classdist_feat} illustrates a proper and poor example of class distribution for a given feature.
